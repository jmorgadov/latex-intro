...
¿Y si queremos hacer referencia a una imágen? Para ello se usa el entorno
\texttt{figure}. Dentro de este entorno no solo podemos agregar una etiqueta,
sino también agregar un pie de figura:
...
\emph{De la misma forma el entrono \texttt{table} servirá para caracterizar tablas.}
